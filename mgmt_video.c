...
#ifndef MGMT_VIDEO_C_
#define MGMT_VIDEO_C_
    ...
    )
{
    ...
    {
        // Cache SPS.
        fprintf(stderr, "MGMT_VIDEO:: New SPS NAL unit");
        ...
        fprintf(stderr, "MGMT_VIDEO:: New SPS NAL unit len %d", f_cblk.sps_nal_unit->nal_unit_len);
    ...
    {
        // Cache PPS.
        fprintf(stderr, "MGMT_VIDEO:: New PPS NAL unit");
    ...
    )
{
    switch(msg->event)
    {
        ...
        {
//            fprintf(stderr, "(idle_state_handler): msg->event_data.service.nal_unit = 0x%x",
...
{
    fprintf(stderr, "(mgmt_video_init): Invoked.");
...
{
    fprintf(stderr, "(mgmt_video_open): Invoked.");
    ...
    )
{
    ...
    fprintf(stderr, "(mgmt_video_activate): Invoked.");
    ...
    )
{
    ...
    fprintf(stderr, "mgmt_video_reset(): Invoked.");
    ...
    )
{
    ...
    fprintf(stderr, "(mgmt_video_get_pps_nal_unit): Invoked.\n");
    ...
    )
{
    ...
    fprintf(stderr, "mgmt_video_get_sps_nal_unit(): Invoked.\n");
    ...
    *nal_unit = *f_cblk.sps_nal_unit;
    ...
    fprintf(stderr, "nal unit %d", nal_unit->nal_unit_len);
